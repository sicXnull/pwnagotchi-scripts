...
def generateHashcatScript(filename):
    ...
    attacks = [
        ...
        # Top1pt8Billion-WPA-probable-v2.txt is a popular wordlist, it claims to be 'WPA probable' but really they just cut out all passwords less then 8 chars, that doesn't make it wifi probable
        ["-a 0", "Top24Million-WPA-probable-v2.txt", "quick-ssid.rule"],
        # Top24Million-WPA-probable-v2.txt is a popular wordlist, it claims to be 'WPA probable' but really they just cut out all passwords less then 8 chars, that doesn't make it wifi probable
